...
def creategcodefile(targetfile, percentage, bedtemp, endtemp):
	targetfile = "./temp/" + targetfile

	# Return list of tuples containing line numbers and lines where string is found
	# return list_of_results

	adddd = search_string_in_file(targetfile, "G")
	print(adddd)

	adddda = search_string_in_file_from_back(targetfile, "G")
	lll = adddda[0]
	vvvv = lll
	print(vvvv)
	adddddf = get_lines_in_file(targetfile)
	...
	upuntilline = actualrange * (float(percentage) * 0.01)
	print(upuntilline)
	...
	createresumefile(targetfile, lll, upuntilline, str(bedtemp), str(endtemp))
